...
export function EsquimaltIcon({ size = 20, className, ...props }: MuniIconProps) {
  return (
    <img
      src="/icons/esquimalt.png"
      alt="Esquimalt Anchor Icon"
      style={{ width: size, height: size, objectFit: "contain" }}
      className={className}
      {...props}
    />
...
export function NorthSaanichIcon({ size = 20, className, ...props }: MuniIconProps) {
  return (
    <img
      src="/icons/north_saanich.png"
      alt="North Saanich Airport & Ferry Icon"
      style={{ width: size, height: size, objectFit: "contain" }}
      className={className}
      {...props}
    />
...
export function MetchosinIcon({ size = 20, className, ...props }: MuniIconProps) {
  return (
    <img
      src="/icons/metchosin.png"
      alt="Metchosin Rolling Hills Icon"
      style={{ width: size, height: size, objectFit: "contain" }}
      className={className}
      {...props}
    />
...
export function HighlandsIcon({ size = 20, className, ...props }: MuniIconProps) {
  return (
    <img
      src="/icons/highlands.png"
      alt="Highlands Mountain & Forest Hills Icon"
      style={{ width: size, height: size, objectFit: "contain" }}
      className={className}
      {...props}
    />
